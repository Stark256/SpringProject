...
<body>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<form:form action="/admin/table" method="POST"
					...
					<div class="form-group row">
						<label class="col-2 col-form-label" for="countOfPeople">Number
							of chairs :</label>
						<div class="col-10">
					...
					<c:forEach var="table" items="${tables}">
						<tr>
							...
							<td class="text-center"><a
								href="/admin/table/update/${table.id}"
								class="btn btn-outline-warning btn-sm">Update</a> <a
								href="/admin/table/delete/${table.id}"
